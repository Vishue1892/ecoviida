      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <?php
            if(isset($_GET['id']))
            {
              $persona_id = mysqli_real_escape_string($con, $_GET['id']);
              $query =  "SELECT * FROM persona WHERE id='$persona_id' ";
              $query_run = mysqli_query($con, $query);

              if(mysqli_num_rows($query_run) > 0)
              {
                $persona = mysqli_fetch_array($query_run);
          ...
          ?>
            <form action="code.php" method="POST">
              ...
              <div class="mb-3">
                ...
                <input type="text" name="apepat" class="form-control">
              </div>
              <div class="mb-3">
                <label>Apellido Materno</label>
                <input type="text" name="apemat" class="form-control">
              </div>
              <div class="mb-3">
                <label>Sexo</label>
              ...
              <div class="mb-3">
                <label>Empresa</label>
                <select type="text" name="empresa" class="form-control">
